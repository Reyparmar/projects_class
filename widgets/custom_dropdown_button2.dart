        ...
        child: DropdownButton2(
          ...
          hint: Container(
            ...
            child: Text(
              ...
              maxLines: 1,
              style: TextStyle().medium.copyWith(fontSize: 22),
            ),
          ),
          value: value,
          items: dropdownItems
              .map((item) => DropdownMenuItem<String>(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        ...
                        overflow: TextOverflow.ellipsis,
                        maxLines: 1,
                        style: const TextStyle().medium.copyWith(fontSize: 16),
                      ),
                    ),
                  ))
              .toList(),
          ...
          dropdownStyleData: DropdownStyleData(
            ...
            scrollbarTheme: ScrollbarThemeData(
              ...
              thumbVisibility:
                  scrollbarAlwaysShow != null ? MaterialStateProperty.all<bool>(scrollbarAlwaysShow!) : null,
            ),
          ),
